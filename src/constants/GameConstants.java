...
public class GameConstants {
    ...
    public static final int[] cashBlock = {0}; //miracle cube and stuffs
    ...
    //public static final String MASTER = "%&HYGEomgLOL";//移除萬能密碼
    public static final String[] RESERVED = {"Rental"};
    
    public static boolean[] GuildWar = {false,false,false,false};

    public static boolean getAllWarStatus(){
        for(int i = 0; i< GuildWar.length;i++)
        {
            if(GuildWar[i])
                return true;
        }
    ...
    public static int getWarStatus(){
        for(int i = 0; i< GuildWar.length;i++)
        {
            if(GuildWar[i])
                return i;
    ...
    public static boolean isGuildPVPMap(final int mapid){
        switch(mapid)
        {
            case 980010100:
                return true;
