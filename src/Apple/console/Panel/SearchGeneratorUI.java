 ...
 * @author Pungin
 */
public class SearchGeneratorUI extends javax.swing.JFrame {

    /**
     * Creates new form SearchGeneratorUI
     */
    private static SearchGeneratorUI instance = null;

    public static SearchGeneratorUI getInstance() {
        if (instance == null) {
            instance = new SearchGeneratorUI();
        }
        return instance;
    }
    ...
    public void search() {
        ...
        if (type == 0) {
            ...
            if (SearchGenerator.SearchType.valueOf(SearchGenerator.SearchType.nameOf(type)) == SearchGenerator.SearchType.道具) {
                for (Pair<Integer, String> itemPair : MapleItemInformationProvider.getInstance().getAllItems()) {
                    if (String.valueOf(itemPair.getLeft()).toLowerCase().contains(str.toLowerCase()) || itemPair.getRight().toLowerCase().contains(str.toLowerCase())) {
