...
import database.DatabaseConnection;//取代 DruidPooledConnection
...
public class DeleteUserData {
    ...
    public synchronized static void run() {
        ...
        for (String name : databasenames) {
            ...
            try (Connection con = DatabaseConnection.getConnection()) {
                ...
                FileoutputUtil.log(FileoutputUtil.DeleteUserData, "清空" + name + "表失敗");
                FileoutputUtil.outputFileError(FileoutputUtil.DeleteUserData, e);
            }
        }
        setKeyChecks(1);
        //WebOptionPane.showMessageDialog(Start.getInstance(), "玩家數據清空完成！");
    }
    ...
    private synchronized static void setKeyChecks(int mode) {
        try (Connection con = DatabaseConnection.getConnection()) {
            ...
            FileoutputUtil.log(FileoutputUtil.DeleteUserData, "操作外鍵失敗");
            FileoutputUtil.outputFileError(FileoutputUtil.DeleteUserData, e);
        }
    }
}
