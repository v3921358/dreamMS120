...
import Apple.console.ItemInformation;
import java.io.File;
...
public class SearchGenerator {
        ...
        switch (type) {
            case 道具:
                for (Pair<Integer, String> itemPair : MapleItemInformationProvider.getInstance().getAllItems()) {
                    values.put(itemPair.getLeft(), itemPair.getRight());
                }
                break;
            case NPC:
    ...
    public static int[] getSearchData5(int type, String search) {
