...
public class PlayerShopPacket {
    ...
    //釣魚小幫手
    public static final byte[] sendFishBox() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] spawnHiredFishing(final HiredFishing hf) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        ...
        PacketHelper.addInteraction(mplew, hf);
        mplew.writeLong(0);

        return mplew.getPacket();
    }

    public static final byte[] updateHiredFishing(final HiredFishing Fishing) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] closeHiredFishing(final HiredFishing Fishing) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static final byte[] fishingItemStore_ItemData(final MerchItemPackage pack) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
