...
public class MTSCSPacket {
    ...
    public static byte[] showAcc(MapleClient c) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] useWheel(int charmsleft) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] showXmasSurprise1(int idFirst, IItem item, int accid) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] showCouponRedeemedItem(Map<Integer, IItem> items, int mesos, int maplePoints, MapleClient c) {
        ...
        */
        ...
        mplew.writeShort(SendPacketOpcode.CS_OPERATION.getValue());
        mplew.write(0x92);
        mplew.write(items.size()); // Cash Item
        for (Entry<Integer, IItem> sn : items.entrySet()) {
            addCashItemInfo(mplew, sn.getValue(), c.getAccID(), sn.getKey().intValue());
        }
        mplew.writeInt(maplePoints);
        mplew.writeInt(items.size()); // Normal items size
    ...
    public static byte[] sendGift(int price, int itemid, int quantity, String receiver, boolean isPackage) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
