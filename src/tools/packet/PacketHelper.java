...
public class PacketHelper {
    ...
    private final static long FT_UT_OFFSET = 116444520000000000L; // EDT
    ...
    public static void addInventoryInfo(MaplePacketLittleEndianWriter mplew, MapleCharacter chr) {
        mplew.writeLong(PacketHelper.getTime_TEST(System.currentTimeMillis()));
    ...
    public static long getTime_TEST(long realTimestamp) {
        if (realTimestamp == -1) {
            return MAX_TIME; //00 80 05 BB 46 E6 17 02
        }
        return KoreanDateUtil.getFileTimestamp_TEST(realTimestamp);
    }

    public static final void addExpirationTime(final MaplePacketLittleEndianWriter mplew, final long time) {
        mplew.writeLong(getTime_TEST(time));
        /*mplew.write(0);
    ...
    public static final void addItemInfo1(final MaplePacketLittleEndianWriter mplew, final IItem item, final boolean zeroPosition, final boolean leaveOut) {
