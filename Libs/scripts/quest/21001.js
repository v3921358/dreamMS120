...
function end(mode, type, selection) {
	...
	qm.sendNextPrev("對，對了！現在不是談這些事情的時機。 黑魔法師的氣息已經慢慢的靠近了！好像已經察覺方舟的位置了！不趕快出發的話，就會被逮個正著。");
    } else if (status == 4) {
	qm.sendNextPrevS("立刻出發！", 3);
    } else if (status == 5) {
	qm.sendNextPrev("狂狼勇士！你也坐上方舟吧！我雖然了解您想火拼到最後一刻的心情…可是已經太遲了！打仗這個任務就交給您的同伴，跟我們一起前往維多利亞島吧！");
    } else if (status == 6) {
