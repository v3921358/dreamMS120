    ...
    if (status == 0) {
        ...
        if (cm.getPlayerStat("LVL") >= 50) {
            ...
            if (cm.getQuestStatus(100200) != 2 && cm.getQuestStatus(100200) != 1) {
                ...
                cm.sendOk("你想挑戰殘暴炎魔的任務嗎？  嗯……。我覺得你有能力承擔這任務。但是這之前，你必須完成我給你的任務。要小心點。");
                ...
                cm.sendNext("你沒有我需要的物品嗎！");

            } else {

                if (cm.haveItem(4001109)) {

                    cm.sendSimple("你想挑戰那一階段？ #b\r\n#L0#廢礦調查 (第一階段)#l\r\n#L1#殘暴炎魔迷宮調查 (第二階段)#l\r\n#L2#請求提煉 (第三階段)#l\r\n#L3#進去打殘暴炎魔#l\r\n#L4#跳過任務 (需要花錢)#l");
            ...
            cm.sendOk("按照你目前的情況，你不能進行這項任務，當你變強的時候，再來找我吧！");
        ...
        if (cm.getPlayer().getMeso() < 300000000) {
            ...
            cm.sendNext("你沒有足夠的楓幣，請檢查一下再來。");

        } else if (!cm.canHold(4001017, 5)) {

            cm.sendNext("你沒有足夠的空間，請檢查一下再來。");
